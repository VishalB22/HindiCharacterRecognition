...
def load_model():
	model = tf.keras.models.load_model("C:\\Users\\visha\\Documents\\Applied AI & ML Diploma\\Hindi Character Recognition\\HCR-CNN.h5")
	return model
...
def main():
    ...
    st.header("Please upload you hindi character image to predict")
    up_image = load_image()
    model = load_model()
    if up_image:
